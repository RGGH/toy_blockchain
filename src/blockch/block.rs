...
impl Block {
    pub fn new(index:u64,previous_hash:String)->Self{
        let block = Block {
            ...
            previous_hash, // what if it's 1st block? It uses String::default(),
            hash : String::default() // gets updated during mine with succesful hash
        };
        block
    }

    // generate_block_hash and check if satisfies difficulty
    ...
    pub fn generate_block_hash(&self)->String{
        ...
        // Calclate and return SHA-256 hash value
